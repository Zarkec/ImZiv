...
// ImZiv uses the ImHex docking ImGui copy locally, but does not ship ImHex's
// test engine runtime.
...
// ImZiv keeps the default stb_truetype font loader to avoid a FreeType runtime
// dependency in the standalone image tool.
// #define IMGUI_ENABLE_FREETYPE
#define ImDrawIdx unsigned int
